...
<body class="dark2">
    ...
    {{-- <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Logistics System') }}
                </a>
    ...
    {{-- <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- Sidebar -->
                    <nav id="sidebar"
                        class="col-md-3 col-lg-2 d-md-block bg-light vh-100 border-end border-dark sidebar">
    ...
    {{-- old sidebar --}}
    {{-- @else --}}
    {{-- @extends('layouts.noAuthForHome') --}}
    {{-- @dd('I am No auth') --}}
    {{-- <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-md-4 py-3">
                @yield('content')
            </main> --}}
    {{-- @dd('testing') --}}
    <!-- Footer section -->
    {{-- @endif
        <footer class="mt-5">
            <div class="container d-flex">
                <p class="ms-auto">&copy; {{ date('Y') }} Your Company Name. All rights reserved.</p>
            </div>
        </footer> --}}
    {{-- </div> --}}
